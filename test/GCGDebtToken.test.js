const GCGDebtTokenMock = artifacts.require('./mocks/GCGDebtTokenMock')

contract('GCGDebtToken', ([sender, recipient, ...accounts]) => {
  ...
  before(async () => {
    token = await GCGDebtTokenMock.new(initialAccount, initialBalance)
